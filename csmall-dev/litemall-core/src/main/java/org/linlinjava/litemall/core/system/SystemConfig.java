...
public class SystemConfig {
    ...
    public final static String LITEMALL_ORDER_CLOSE = "litemall_order_close";
    // 商场相关配置
    ...
    // 客服相关配置
    public final static String LITEMALL_CUSTOMER_QQ = "litemall_customer_qq";
    public final static String LITEMALL_CUSTOMER_WX = "litemall_customer_wx";
    public final static String LITEMALL_CUSTOMER_PHONE = "litemall_customer_phone";
    public final static String LITEMALL_CUSTOMER_EMAIL = "litemall_customer_email";
    ...
    public static String getLitemallCustomerQq() {
        return getConfig(LITEMALL_CUSTOMER_QQ);
    }
    public static String getLitemallCustomerEmail() {
        return getConfig(LITEMALL_CUSTOMER_EMAIL);
    }

    public static String getLitemallCustomerWx() {
        return getConfig(LITEMALL_CUSTOMER_WX);
    }

    public static String getLitemallCustomerPhone() {
        return getConfig(LITEMALL_CUSTOMER_PHONE);
    }

    public static Integer getLitemallOrderClose() {
        return getConfigInt(LITEMALL_ORDER_CLOSE);
    }
}
