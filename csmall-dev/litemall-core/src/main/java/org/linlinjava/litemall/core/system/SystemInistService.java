...
class SystemInistService {
    ...
    static {
        ...
        // 客服相关配置默认值
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_CUSTOMER_QQ, "123456");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_CUSTOMER_WX, "123456");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_CUSTOMER_PHONE, "123456");
    }
    ...
    private Map<String, String> getSystemInfo() {
       ...
       // infos.put("本地对象存储路径", environment.getProperty("litemall.storage.local.storagePath"));
        ...
        infos.put("微信APP KEY", environment.getProperty("litemall.wx.login-app-id"));
