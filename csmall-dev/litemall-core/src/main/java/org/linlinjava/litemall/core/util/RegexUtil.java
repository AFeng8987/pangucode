...
public class RegexUtil {
     ...
     * Regex of telephone number.
     */
    public static final String REGEX_TEL_NEW= "^(\\(\\d{3,4}\\)|\\d{3,4}-|\\s)?\\d{7,10}$";
    /**
    ...
    /**
     * Regex of username.
     * <p>scope for "a-z", "A-Z", "0-9", "_", "-"</p>
     */
    public static final String REGEX_QQWX = "^[a-zA-Z0-9_-]{5,19}$";
    /**
     * Regex of 英文字母+数字的+"_"
     * <p>scope for "a-z", "A-Z", "0-9", "_", "-"</p>
     */
    public static final String REGEX_LETTER = "^[a-z0-9A-Z_]+$";
    /**
     ...
     * Regex of QQ number.
     */
    public static final String REGEX_QQ_NUM = "[1-9][0-9]{4,12}";
    /**
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isTelNew(final CharSequence input) {
        return isMatch(REGEX_TEL_NEW, input);
    }
