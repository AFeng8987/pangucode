...
public class ResponseUtil {
    ...
    public static Object okList(List list,Map<String, Object> data ) {
        data.put("list", list);
        if (list instanceof Page) {
            Page page = (Page) list;
            data.put("total", page.getTotal());
    ...
    public static Object badArgumentValue(String errmsg) {
        return fail(402, errmsg);
    }
    ...
    public static Object invalid() {
        return fail(9999, "Token无效");
    }

    public static Object frequently() {
        return fail(999, "请求过于频繁");
    }
}
