...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public Object nullPointerHandle(NullPointerException e) {
        logger.error("系统发生了空指针异常。", e);
        return ResponseUtil.serious("系统发生了空指针异常，"+e.getMessage());
    }
    ...
    @ResponseBody
    public Object runtimeHandle(RuntimeException e) {
        logger.error("系统发生了运行异常。", e);
        return ResponseUtil.serious("系统发生了运行异常，"+e.getMessage());
    }
}
