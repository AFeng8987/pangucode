...
//        Callable<List> newGoodsListCallable = () -> goodsService.queryByNew(0, SystemConfig.getNewLimit());
        ...
        Callable<List> goodsListCallable = () -> goodsService.queryHomeByPage(1, 10);
...
//        Callable<List> floorGoodsListCallable = this::getCategoryList;
        ...
        //查询活动板块表列表
        Callable<List> activityCallable = () -> litemallActivity.activityList(1, 10);

        FutureTask<List> bannerTask = new FutureTask<>(bannerListCallable);
//        FutureTask<List> newGoodsListTask = new FutureTask<>(newGoodsListCallable);
        FutureTask<List> hotGoodsListTask = new FutureTask<>(hotGoodsListCallable);
        FutureTask<List> activityTask = new FutureTask<>(activityCallable);
        FutureTask<List> goodsTask = new FutureTask<>(goodsListCallable);
...
//            entity.put("newGoodsList", newGoodsListTask.get());
            ...
            entity.put("activity", activityTask.get());
            entity.put("goodsList", goodsTask.get());
...
//            entity.put("floorGoodsList", floorGoodsListTask.get());
    ...
    public Object goodsPage(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "10") Integer limit) {

        return ResponseUtil.okList(goodsService.queryHomeByPage(page, limit));
