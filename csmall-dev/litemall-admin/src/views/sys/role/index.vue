<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/role/list']" class="filter-item" type="primary" icon="el-icon-search" size="small" @click="handleFilter">查找</el-button>
    </div>
      ...
      <div slot="header" class="clearfix">
        <el-row :gutter="24" type="flex" align="middle">
          ...
          <el-col :span="14" style="text-align: right">
            <el-button v-permission="['POST /admin/role/create']" class="filter-item" type="primary" icon="el-icon-edit" size="small" @click="handleCreate">添加</el-button>
          </el-col>
        </el-row>
      </div>
      <!-- 查询结果 -->
