...
/**
 * 作者 ：HealerJean 邀请码生成器，算法原理： 1) 获取id: 1111111 2) 使用自定义进制转为：gpm6 3)
 * 转为字符串，并在后面加'O'字符：gpm6o 4）在后面随机产生若干个随机数字字符：gpm6o7
...
public class ShareCodeUtil {
    ...
    public static void main(String[] args) throws IOException {
        for (int i = 0; i < 30; i++) {
            String ss="推广码:" + toSerialCode(1);
            System.out.println(ss);

            System.out.println(codeToId(ss));
        }
